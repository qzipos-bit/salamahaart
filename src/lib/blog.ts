...
export type BlogPost = {
  ...
  coverAlt: string;
  /** Соотношение сторон обложки на странице статьи (по умолчанию 16/9) */
...
const BLOG_POSTS: BlogPost[] = [
  {
    ...
    category: "article",
    coverImage: "/blog-uhod-stoleshnica-infografika.webp",
    coverAlt:
      "Инфографика: как ухаживать за столешницей из эпоксидной смолы — шесть правил ухода",
    coverAspect: "4/3",
    content: [
