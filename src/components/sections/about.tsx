        ...
        <div className="grid items-center gap-12 lg:grid-cols-12 lg:gap-16">
          ...
          <div className="lg:col-span-6 lg:col-start-7">
            ...
            <p className="mt-6 text-base leading-relaxed text-fg/75">
              ...
              по-настоящему живо. Создаю изделия с эпоксидной смолой, в которых
              дерево и эпоксидная смола раскрываются через свет, фактуру и
              глубину.
            </p>
            <p className="mt-4 text-base leading-relaxed text-fg/75">
              ...
              и детали, которые видно только вблизи. Это могут быть изделия из
              дерева и эпоксидной смолы, декор из эпоксидной смолы для интерьера
              или индивидуальный предмет в подарок.
            </p>
